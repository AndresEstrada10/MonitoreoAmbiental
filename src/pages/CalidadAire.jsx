...
export default function CalidadAire() {
  usePageTitle("Calidad del Aire | ClimaWatch");
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        >
          <div>
            ...
            <select
              ...
              aria-describedby={errors.zona ? "calidad-zona-error" : undefined}
              {...register("zona")}
            >
            ...
            {errors.zona && (
              <p id="calidad-zona-error" className="text-red-600 text-sm mt-1">
                {errors.zona.message}
              </p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              aria-describedby={
                errors.ciudad ? "calidad-ciudad-error" : undefined
              }
              {...register("ciudad")}
            />
            {errors.ciudad && (
              <p
                id="calidad-ciudad-error"
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg h-fit"
          >
            Buscar
          </button>
        </form>
        ...
        <div className="space-y-4">
          <div className="bg-yellow-100 dark:bg-yellow-900/30 border-l-4 border-yellow-500 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-semibold text-yellow-900 dark:text-yellow-300 mt-1">
                  {resultados.estado}
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {resultados.contaminantes.map((cont, idx) => (
              <div
                key={idx}
                className="bg-white dark:bg-slate-800 rounded-lg p-4 border-l-4 border-blue-500"
              >
